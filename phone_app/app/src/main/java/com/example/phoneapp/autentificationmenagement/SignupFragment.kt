...
class SignupFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        signupBtn.setOnClickListener {
            ...
            var username :String? = signupUsername.editText.toString()
            var email : String? = signupEmail.editText.toString()
            var password: String? = signupPassword.editText.toString()
            var passwordConfirm : String? = signupPasswordConfirm.editText.toString()
...
//            }
//            else{
//                loginAndSignupActivity!!.viewModel.signup(userName,email,password,passwordCheck)
//            }
